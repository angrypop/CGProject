...
constexpr int TEXTURECOORDSIZE = 2;							// every point has texture coordinate data like (x, y)
constexpr int POINTSIZE = COORDSIZE + TEXTURECOORDSIZE;		// every point has texture and coordinate data

enum class ViewObjectEnum { PlaneObject, BallObject, TriangleObject, PolygonObject, RectangleObject};
enum class ViewPassEnum { Shadow, GBuffer, OITBuffer, BlendOIT, GBufferIlluminate};
