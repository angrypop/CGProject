...
public:
	...
	// active this texture to given attachment
	void Prepare(const GLuint& attachment);
	...
	void Init(const std::string& samplerName);
...
public:
	...
	// active this texture to given attachment
	void Prepare(const GLuint& attachment = GL_DEPTH_ATTACHMENT);
protected:
	GLsizei _width, _height;
