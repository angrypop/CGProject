//#pragma once
//
//enum { SphereVAO, NumSphereVAO };
//enum { SphereArrayBuffer, SphereElementBuffer, NumSphereBuffer };
//
//class Sphere {
//public:
//	GLuint VAOs[NumSphereVAO];
//	GLuint Buffers[NumSphereBuffer];
...
//public:
//	Sphere() {};
//	Sphere(glm::vec3 position, GLfloat points[], GLint sizeofPoints, GLuint indices[], GLint sizeofIndices, ShaderInfo shaders[], TextureInfo textures[]) {
...
//	}
//
//	void render(glm::vec3 lightPosition, glm::vec3 viewPosition, glm::mat4 uniV, glm::mat4 uniP, glm::mat4 translate = glm::mat4(1)) {
//		GLint location;
//		glUseProgram(Program);
//		location = glGetUniformLocation(Program, "uniM");
